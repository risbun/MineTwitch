...
<ol>
	...
	<li>Go to <a href="https://twitchapps.com/tmi/">this site</a> in a browser and acquire a oauth token. Put this token in the config file after <pre>ouath:</pre></li>
	<li>Type in the name of the account you used when acquiring the oauth token after <pre>username:</pre></li>
	<li>Type in your Twitch channles name (can be the same as your username) after <pre>channel:</pre></li>
